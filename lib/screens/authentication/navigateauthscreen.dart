...
import 'package:laxo/screens/authentication/loginscreen.dart';
import 'package:laxo/screens/authentication/registerscreen.dart';
      ...
      body: Stack(
        children: [
          Container(
            ...
            child: Center(
              child: Image.asset('assets/images/test3.png', height: 100),
            ),
          ),
          Align(
